...
function ModalProfile({ type }: IModalProfile) {
    const {
        ...
        email,
        bio,
        image } = useUserStore(state => state)
    ...
    return (
        <Dialog>
            <DialogTrigger><FaPen className="cursor-pointer" /></DialogTrigger>
                ...
                <form action="">
                    ...
                    <FormGroup gap={24} top={24}>
                        <Input
                            ...
                            error={Boolean(formik.touched.createdAt && formik.touched.createdAt)}
                        ...
                        <Input
                            ...
                            error={Boolean(formik.touched.updatedAt && formik.touched.updatedAt)}
